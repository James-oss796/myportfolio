...
export default function Projects() {
  ...
  return (
      <section data-aos='fade-up' data-aos-delay='4600' id='projects' className='relative overflow-hidden flex flex-col text-white body-font'>
        <div className='container px-5 py-24 mx-auto'>
            <h2 className='text-4xl font-bold text-center mb-12'>My Projects</h2>
            <Slider {...settings}>
                   {
                    listProjects.map((project)=>(
                        <div data-aos='fade-up' data-aos-delay='700' key={project.id} className='p-4'>
